...
{
    public class Utf8TileMapper : ITileMapper
    {
        ...
        {
            var otherTileId = AsciiToUtf8Map[tileId];
            return otherTileId;
        }

        public int GetTileId(object alternativeTileId)
        {
            var character = (char)alternativeTileId;
            var tileId = Array.IndexOf(AsciiToUtf8Map, (int)character);
            return tileId;
        }
    }
}
